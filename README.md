...
По комментариям от ревьюера:
1. страницы ошибок есть. 
2. все обработчики событий навешиваются на "головной" элемент страницы и ловятся при всплывании. тк навешивание событий происходит в методе рендер блока. 
...
10. смена аватарок
11. добавление, удаление пользователей в чате